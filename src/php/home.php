...
<html lang="de">
    ...
    <body>
        ...
        <!--Warenkorb test-->
        <div>
        <button onclick="location.href='warenkorb.php'" class="orange" style="color: white;">warenkorb</button>
        </div>
        ...
        <div class="FlexImg" style="position: relative;">
            ...
            <div style="position: absolute; text-align: center;">
                ...
                <button onclick="location.href='oWatch.php'" class="white clearWhite">Kaufen</button>
            </div>
        </div>
        ...
        <div class="FlexImg" style="position: relative;">
            ...
            <div style="position: absolute; text-align: center;">
                ...
                <button onclick="location.href='shop.php'" class="orange" style="color: white;">Weitere Infos</button>
                <button onclick="location.href='earthPods.php'" class="orange clearOrange">Kaufen</button>
            </div>
        </div>
