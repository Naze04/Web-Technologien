	    ...
	    <div class="rahmen">
            <div class="AboutUsInhalt">
                <table class="TableInhalt" width="1080">
	    			<tr>
                        <td>
                            <section class="Texthintergrund"><h2 class="Uberschrift">About<span class="Uberschrifthalfte">Us</span></h2>
                                <div class="Beschreibung">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.
